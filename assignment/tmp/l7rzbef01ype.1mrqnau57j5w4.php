              ...
              <div class="card text-left">
                ...
                <div class="tab-content">
                  ...
                  <div class="card-body tab-pane" id="render_costa">
                    ...
                    <div class="btn-group ">
                      <a href="javascript:void(0);" class="btn btn-primary btn-responsive camera-font" onclick="document.getElementById('model__coasttexture').setAttribute('url','texture/costa.png');">Original</a>
                    </div>
                    <div class="btn-group ">
                      <a href="javascript:void(0);" class="btn btn-primary btn-responsive camera-font" onclick="document.getElementById('model__coasttexture').setAttribute('url','texture/costa1.png');">New texture</a>
                    </div>
                    <div class="btn-group ">
                      <a href="javascript:void(0);" class="btn btn-primary btn-responsive camera-font" onclick="document.getElementById('model__coasttexture').setAttribute('url','texture/costaNo.png');">No texture</a>
                    </div>
                  </div>
              ...
              <div class="card text-left">
                ...
                <div class="tab-content">
                  ...
                  <div class="card-body tab-pane" id="render_oasis">
                    ...
                    <div class="btn-group ">
                      <a href="javascript:void(0);" class="btn btn-primary btn-responsive camera-font" onclick="document.getElementById('model__oasistexture').setAttribute('url','texture/oasis.jpg');">Original</a>
                    </div>
                    <div class="btn-group ">
                      <a href="javascript:void(0);" class="btn btn-primary btn-responsive camera-font" onclick="document.getElementById('model__oasistexture').setAttribute('url','texture/oasis1.jpg');">New texture</a>
                    </div>
                    <div class="btn-group ">
                      <a href="javascript:void(0);" class="btn btn-primary btn-responsive camera-font" onclick="document.getElementById('model__oasistexture').setAttribute('url','texture/oasisNo.jpg');">No texture</a>
                    </div>
                  </div>
              ...
              <div class="card text-left">
                ...
                <div class="tab-content">
                  ...
                  <div class="card-body tab-pane" id="render_smartwater">
                    ...
                    <div class="btn-group ">
                      <a href="javascript:void(0);" class="btn btn-primary btn-responsive camera-font" onclick="document.getElementById('model__smartwatertexture').setAttribute('url','texture/smartwater.png');">Original</a>
                    </div>
                    <div class="btn-group ">
                      <a href="javascript:void(0);" class="btn btn-primary btn-responsive camera-font" onclick="document.getElementById('model__smartwatertexture').setAttribute('url','texture/smartwater1.png');">New texture</a>
                    </div>
                    <div class="btn-group ">
                      <a href="javascript:void(0);" class="btn btn-primary btn-responsive camera-font" onclick="document.getElementById('model__smartwatertexture').setAttribute('url','texture/smartwaterNo.png');">No texture</a>
                    </div>
                  </div>
              ...
              <div id="reference_content" style="width: 900px;">
                 <table class="table" style="color:white">
                    <tr>
                      <td>No.</td>
                      <td>Link</td>
                      <td>Citation and reference description</td>
                    </tr>
                    <tr>
                      <td>1.</td>
                      <td>http://users.sussex.ac.uk/~martinwh/3dapp/labs/
                      </td>
                      <td>The main source of learning and reference for this website is as a basic template, used to quickly build the front-end pages of the website. The overall layout method is referenced, but most of the color matching, page layout, and content have been modified and redesigned. Some 3D Models JavaScript code has been referenced and referenced to achieve 3D Models camera perspective and lighting control, as well as motion rotation and other operations. But through imitation, a new rotation method and texture switching were achieved.</td>
                    </tr>

                    <tr>
                      <td>2.</td>
                      <td>https://www.coca-cola.co.uk/</td>
                      <td>The brands images and models resources in the webpage, as well as the introduction text sources on the page, are generally stored in the app/data/data.json file and called through the front-end $. getJson method.</td>
                    </tr>
                    <tr>
                      <td>3.</td>
                      <td>https://www.pexels.com/</td>
                      <td>Obtain and use background images from the front-end page and image resources from the gallery page on this website, all of which are open-source resources.</td>
                    </tr>
                    <tr>
                      <td>4.</td>
                      <td>https://www.w3cschool.cn/</td>
                      <td>Learn basic HTML, CSS, and JavaScript operations.The basic framework and style modifications used to build web pages, as well as the modification and dynamic changes of page elements.</td>
                    </tr>
                    <tr>
                      <td>5.</td>
                      <td>https://getbootstrap.com/</td>
                      <td>This website mainly uses the bootstrap front-end framework. This link is used to learn about the styles and components related to the framework, including webpage layout, tables, navigation, menu switching, and buttons.</td>
                    </tr>
                    <tr>
                      <td>6.</td>
                      <td>https://fex.baidu.com/webuploader/</td>
                      <td>Image upload plugin, this plugin is used to help upload images through Ajax, using SPA pages to avoid refreshing the entire page. This plugin is referenced in the upload method on the gallery page, which is used in app/view/js/fileupload.js.</td>
                    </tr>
                    <tr>
                      <td>7.</td>
                      <td>https://github.com/fancyapps/fancybox</td>
                      <td>This plugin is used for zooming in on images, and these references are referenced in the home page and model page.
                    </tr>
                    <tr>
                      <td>8.</td>
                    ...
                    <td> https://fatfreeframework.com/3.8/home
                      ...
                      <td>In order to meet the application structure of page MVC, this page uses the fatfreeframework to achieve this goal. Mainly drawing on the routing part and UI template engine of this framework, index.php implements page routing and jumping, the controller part implements parameter reception and page rendering of the front-end page, and the model implements modification and acquisition of database and JSON data.</td>
                    </tr>
                    <tr>
                      <td>10.</td>
                    <td>  https://www.cnblogs.com/ctb-web/p/9968288.html
                      ...
                      <td>These code references are referenced in app/view/js/index.js.Because the website is a spa application, it will take a long time for the page to load for the first time. It needs to display pages loading to inform the user that the page resources are loading. Therefore, the syntax of ES6 needs to be used to implement this process, and the page has borrowed some of the ES6 code from this blog.</td>
                    </tr>
                 </table>
              </div>
      ...
      <div class="row video" style="background:rgba(0,0,0,0.3);padding: 30px;min-height: 600px;">
          <div id="reference_content" style="width: 900px;color:white">
            <table class="table" style="color:white">
              ...
              <tr>
                <td>1.</td>
                <td><a style="color:white" href="https://github.com/wuysh/3dapp/tree/main/assignment/3dmodel" target="_blank">https://github.com/wuysh/3dapp/tree/main/assignment/3dmodel</a></td>
                <td>3D models（VRML/X3D）</td>
              </tr>

              <tr>
                <td>2.</td>
                <td><a style="color:white" href="https://github.com/wuysh/3dapp/tree/main/assignment" target="_blank">https://github.com/wuysh/3dapp/tree/main/assignment</a></td>
                <td>3D app source code</td>
              </tr>
           </table>
        </div>
          </div>
...
<!-- 3d statement section -->
<div class="container-fluid hide" style="background:url('./app/view/assets/images/about.jpg') repeat-y;" id="3dstatement">
  <div class="about_content" style="padding: 60px 0px;">
    <h1 style="text-align: center;color: white;margin-bottom:60px;">3d Deeper Understanding Statement</h1>
    
    <div class="row video" style="background:rgba(0,0,0,0.3);padding: 30px;min-height: 600px;">
        <div id="reference_content" style="width: 900px;color:white">
            <h2>Coca-Cola Folk Website</h2>
            <p>
              <br> 
              1.Based on the guidance of basic knowledge in labs and online self-learning, I used Blender tool to create 3D models (three brands: Coasta, Oasis, and Smartwater) in this assignment. 
              <br> <br>
              2.In this assignment, I extensively used the jquery plugin for page element operations, such as using AJAX methods and using the $("") selector for operations. Use fadeIn(), hide() to display and hide elements. There are also some additional plugins based on jquery implementation, such as jquery. fancybox. min. js (for zooming and displaying images), webupload. min. js (for uploading images), bootstrap. min. js (for using the front-end CSS framework)
              <br> <br>
3.In the gallery section of the page, I used PDO to perform data operations on sqlite data, such as linking databases, adding and deleting images. The specific code can be found in/ View in the app/model/model.php directory file.
<br> <br>
4.In this assignment, I referred to online materials and decided to use the Fatfree framework to build the application MVC. It is similar to Slim but more lightweight and easy to understand. The corresponding structure can be viewed in the controller, model, and view folders in the app directory.
<br> <br>
5.The front-end page of this website is built based on bootstrap, and the page layout uses grid layout. The page uses components such as tabs, navigation, tabs, buttons, images, and modules.
<br> <br>
6.In the front-end and back-end interaction of the website, AJAX is used, and the following APIs are used in the backend to load page content, upload images, and obtain and modify data for gallery images.
<br>  
...
<br> 
The specific implementation process can be found in/ View on app/controller/controller. php.
<br>  <br>
7. New rotation methods used in the interaction of 3D models.
<br>  <br>
8. Implementation of loading animations. By consulting materials and using the ES6 syntax, I easily implemented the wait animation for page initialization, which is a good practice for SPA applications to avoid excessive blank space time during page loading.
<br>  <br>
9. Upload images through plugins. When uploading images, using traditional form forms can cause page refresh, which is not friendly for a SPA application as it starts from the homepage. Therefore, through learning online materials and using the webuploader plugin, I achieved non refresh upload of images.
            </p>
